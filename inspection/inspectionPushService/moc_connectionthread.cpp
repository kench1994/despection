...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConnectionThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 6)
    ...
    "ConnectionThread\0serverConnected\0\0"
    "result"
};
...
void ConnectionThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->serverConnected((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ConnectionThread::*_t)(const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectionThread::serverConnected)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ConnectionThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ConnectionThread.data,
      qt_meta_data_ConnectionThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConnectionThread.stringdata))
...
// SIGNAL 0
void ConnectionThread::serverConnected(const bool & _t1)
{
