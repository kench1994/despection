...
#include "src/imageProcess/qtcamera.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtCamera_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 96, 25),
QT_MOC_LITERAL(10, 122, 6),
QT_MOC_LITERAL(11, 129, 12),
QT_MOC_LITERAL(12, 142, 15),
QT_MOC_LITERAL(13, 158, 15),
QT_MOC_LITERAL(14, 174, 18),
QT_MOC_LITERAL(15, 193, 21),
QT_MOC_LITERAL(16, 215, 10),
QT_MOC_LITERAL(17, 226, 18),
QT_MOC_LITERAL(18, 245, 4),
...
const QMetaObject QtCamera::staticMetaObject = {
    { &QCamera::staticMetaObject, qt_meta_stringdata_QtCamera.data,
      qt_meta_data_QtCamera,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtCamera.stringdata))
...
int QtCamera::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QObject**>(_v) = mediaObject(); break;
        }
        _id -= 1;
