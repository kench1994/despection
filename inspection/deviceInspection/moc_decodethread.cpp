...
#include "src/imageProcess/decodethread.h"
...
QT_MOC_LITERAL(8, 98, 13)
    ...
    "DecodeThread\0decodeFinished\0\0"
...
void DecodeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->decodeFinished((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const bool(*)>(_a[3]))); break;
        case 1: _t->encodeFinished((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const bool(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (DecodeThread::*_t)(const QString & , const QString & , const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecodeThread::decodeFinished)) {
                *result = 0;
            }
        }
        {
            typedef void (DecodeThread::*_t)(const QString & , const QString & , const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DecodeThread::encodeFinished)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void DecodeThread::encodeFinished(const QString & _t1, const QString & _t2, const bool & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
