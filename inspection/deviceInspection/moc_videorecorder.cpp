...
#include "src/imageProcess/videorecorder.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoRecorder_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 35, 15)
    ...
    "VideoRecorder\0createVideoSavePath\0\0"
    "deleteVideoFile"
};
...
void VideoRecorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { QString _r = _t->createVideoSavePath();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 1: _t->deleteVideoFile(); break;
        default: ;
        }
    }
}

const QMetaObject VideoRecorder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoRecorder.data,
      qt_meta_data_VideoRecorder,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoRecorder.stringdata))
        return static_cast<void*>(const_cast< VideoRecorder*>(this));
