...
//"TaskGroupDataKeyやTaskDataKeyやTaskGroupNameやPostIDやTotalObjectCountやExamObjectCountやRFIDCodeやBarCodeやQRCodeやOrderIndex"/>
    onTriggered: {
        ...
        console.log("transmitManager.requestData   EISM_GetTaskObjectListByGroup ")
        transmitManager.requestData(head, para, inspectionSuitDelegate.actionSequence, "获取巡检对象列表失败");
    }
