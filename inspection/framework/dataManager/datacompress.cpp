...
DataCompress::DataCompress(QObject *parent) :
    QObject(parent)
{
}
 ...
 */
bool DataCompress::gzipCompress(QByteArray input, QByteArray &output, int level)
{
    /// Prepare output
    output.clear();
 ...
 */
bool DataCompress::gzipDecompress(QByteArray input, QByteArray &output)
{
    /// Prepare output
    output.clear();
